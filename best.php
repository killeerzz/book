...
<div class="left">	
	...
	<h4><a href="kontakkami.php">Kontak Kami</a></h4>
		...
		<div class="middle">
			<h3><p class="tempat-mengetik">Selamat Datang Di PT. OFFSET SURYA MUSABA</p><p style="margin-bottom: 0px;background: #137409 none repeat scroll 0% 0%;width: 10em;color: #FFF;font-size: 16px;padding-left: 5px;">Best seller</h3>
